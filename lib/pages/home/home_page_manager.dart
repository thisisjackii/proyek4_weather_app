...
import 'package:proyek4_weather_app/services/local_storage.dart';
import 'package:proyek4_weather_app/services/service_locator.dart';
import 'package:proyek4_weather_app/services/web_api.dart';
  ...
  Future<void> loadWeather() async {
    ...
    try {
      final weather = await _webApi.getWeather(
        longitude: -6.860837679429374,
        latitude: 107.53612653796016,
      );
